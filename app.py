...
def main():
    ...
    with tab1:
        ...
        if input_image_vgg16 is not None:
            predicted_label_vgg16 = predict_image(model_paths['VGG16'], input_image_vgg16)
    ...
    with tab2:
        ...
        if input_image_resnet50 is not None:
            predicted_label_resnet50 = predict_image(model_paths['ResNet50'], input_image_resnet50)
    ...
    with tab3:
        ...
        if input_image_densenet121 is not None:
            predicted_label_densenet121 = predict_image(model_paths['DenseNet121'], input_image_densenet121)
    ...
    with tab4:
        ...
        if input_image_alexnet is not None:
            predicted_label_alexnet = predict_image(model_paths['AlexNet'], input_image_alexnet)
    ...
    with tab5:
        ...
        if input_image_efficientnet is not None:
            predicted_label_efficientnet = predict_image(model_paths['EfficientNet'], input_image_efficientnet)
